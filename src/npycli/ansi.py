...
__constants["BACKGROND_BLACK"] = FOREGROUND_BLACK + 10
BACKGROND_BLACK: int = __constants["BACKGROND_BLACK"]

__constants["BACKGROND_RED"] = FOREGROUND_RED + 10
BACKGROND_RED: int = __constants["BACKGROND_RED"]

__constants["BACKGROND_GREEN"] = FOREGROUND_GREEN + 10
BACKGROND_GREEN: int = __constants["BACKGROND_GREEN"]

__constants["BACKGROND_YELLOW"] = FOREGROUND_YELLOW + 10
BACKGROND_YELLOW: int = __constants["BACKGROND_YELLOW"]

__constants["BACKGROND_BLUE"] = FOREGROUND_BLUE + 10
BACKGROND_BLUE: int = __constants["BACKGROND_BLUE"]

__constants["BACKGROND_MAGENTA"] = FOREGROUND_MAGENTA + 10
BACKGROND_MAGENTA: int = __constants["BACKGROND_MAGENTA"]

__constants["BACKGROND_CYAN"] = FOREGROUND_CYAN + 10
BACKGROND_CYAN: int = __constants["BACKGROND_CYAN"]

__constants["BACKGROND_WHITE"] = FOREGROUND_WHITE + 10
BACKGROND_WHITE: int = __constants["BACKGROND_WHITE"]

__constants["BACKGROND_DEFAULT"] = FOREGROUND_DEFAULT + 10
